...
try:
    ...
    # Etiqueta para mostrar la hora del día
    time_of_day_label = tk.Label(root, text="Hora del día: 00:00", font=("Arial", 12), anchor='e', justify='right')
    time_of_day_label.place(x=900, y=10)
