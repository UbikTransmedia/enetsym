...
try:
    ...
    def dibujar_red():
        ...
        # Mostrar las unidades en el eje Y e indicar a qué serie pertenece cada unidad
        unidades_y = sorted(set(serie_estaciones_cero + serie_estaciones_max + serie_distribuidores_sobrecargados))
        ax2.set_yticks(unidades_y)
        ax2.set_yticklabels(unidades_y)
