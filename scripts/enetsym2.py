...
def actualizar():
    ...
    # Actualizar la visualización cada cierto número de iteraciones
    if contador_dibujo % frecuencia_dibujo == 0:
        dibujar_red()
        contador_dibujo = 0
...
contador_dibujo = 0
frecuencia_dibujo = 100  # Actualizar visualización cada 100 iteraciones
